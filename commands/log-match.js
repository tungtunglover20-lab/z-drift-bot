...
const { loadMatches, saveMatches, withLock: withMatchLock } = require('../utils/matchStore');
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!hasPermission(perms, interaction.user.id, 'log-match')) {
    ...
    // Persist the result so /team can compute win-loss records from it.
